...
ALTER TYPE public.account_type OWNER TO rhiddlescode_database_user;
-- Table structure for table `classifaication`
...
ADD CONSTRAINT fk_classification FOREIGN KEY (classification_id) REFERENCES public.classification (classification_id) MATCH SIMPLE ON UPDATE CASCADE ON DELETE NO ACTION -- Table structure for table `account`
...
-- Data for a table	`classification`
